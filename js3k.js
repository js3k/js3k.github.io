...
top:10px;right:3%;z-index:1;display:inline-block;transition:0.5s;
}
#btn{display:none}
...
#data{
  ...
  left:4px;top:3.7em;right:4px;bottom:4px;
  overflow:scroll;
}
</style>
...
const url = `https://api.github.com/repos/js3k/js3k.github.io/contents/data`;
fetch(url)
  .then((response) => {
    if (!response.ok) {
