 ...
 * @param {number} count
 */
export function set_circle_count(count) {
    wasm.set_circle_count(count);
}

function __wbg_adapter_8(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__hc3d811e1ab8f74f1(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rust_canvas_jelly.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
